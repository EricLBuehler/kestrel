; ModuleID = './tests/tmp.ke'
source_filename = "./tests/tmp.ke"
target triple = "x86_64-unknown-linux-gnu"

@0 = private constant [60 x i8] c"Error: std::i32 addition overflow!\0A    ./tests/tmp.ke:2:17\0A\00"
...
7:                                                ; preds = %2
  %8 = call i32 @printf(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @0, i32 0, i32 0))
  br label %10
...
!2 = !DIFile(filename: "./tests/tmp.ke", directory: ".")
