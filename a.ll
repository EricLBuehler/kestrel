...
@str = private unnamed_addr constant [50 x i8] c"Error: i32 addition overflow!\0A    program.ke:1:10\00", align 1

; Function Attrs: nofree noinline norecurse nounwind
define i32 @main(i32 %0, i32** nocapture readnone %1) local_unnamed_addr #0 {
  %3 = tail call i1 @llvm.expect.i1.i1(i1 false, i1 false)
